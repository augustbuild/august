...
// Social media URLs
const SOCIAL_LINKS = {
  YOUTUBE: 'https://www.youtube.com/@august_build?sub_confirmation=1',
  INSTAGRAM: 'https://www.instagram.com/august.build/',
  TIKTOK: 'https://www.tiktok.com/@august_build',
};
  ...
  return (
    <footer className="bg-background border-t mt-auto">
      <div className="container mx-auto py-8 px-4">
        ...
        <div className="mb-10">
          <h3 className="font-semibold text-lg mb-4">Discover Extraordinary Products</h3>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li>
                <Link to="/reviews" className="text-muted-foreground hover:text-primary transition">
                  Reviews
                </Link>
              </li>
              <li>
                <Link to="/materials" className="text-muted-foreground hover:text-primary transition">
                  Materials
                </Link>
              </li>
              <li>
                <Link to="/collections" className="text-muted-foreground hover:text-primary transition">
                  Collections
                </Link>
              </li>
            </ul>
